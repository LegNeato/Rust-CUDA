...
@"private$1" = private unnamed_addr constant <{ ptr, [8 x i8] }> <{ ptr @"private$0", [8 x i8] c"\1B\00\00\00\00\00\00\00" }>, align 8

declare void @__rust_eh_personality()

; Function Attrs: inlinehint nounwind
define void @"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$16chunks_exact_mut17h8b4674d143cef990E"(ptr noalias nocapture sret({ { ptr, i64 }, { ptr, i64 }, i64, {} }) align 8 dereferenceable(40) %0, ptr nonnull align 1 %1, i64 %2, i64 %3, ptr nonnull align 8 %4) unnamed_addr #0 !dbg !4 {
start:
...
bb2:                                              ; preds = %start
  %16 = bitcast ptr %10 to ptr, !dbg !56
  call void @_ZN4core3fmt9Arguments9new_const17hdf2f30aca51edfbdE(ptr noalias nocapture align 8 dereferenceable(48) %16, ptr nonnull align 8 @"private$1"), !dbg !56
  %17 = bitcast ptr %10 to ptr, !dbg !56
  call void @_ZN4core9panicking9panic_fmt17hbcd5653c6dc71186E(ptr noalias nocapture align 8 dereferenceable(48) %17, ptr nonnull align 8 %4), !dbg !56
  unreachable, !dbg !56

bb1:                                              ; preds = %start
  call void @"_ZN4core5slice4iter23ChunksExactMut$LT$T$GT$3new17ha5b9700c82ce6b00E"(ptr noalias nocapture align 8 dereferenceable(40) %0, ptr nonnull align 1 %1, i64 %2, i64 %3), !dbg !57
  ret void, !dbg !58
}

; Function Attrs: inlinehint nounwind
define void @"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$22split_at_mut_unchecked17h96cf66b4b6523c29E"(ptr noalias nocapture sret({ { ptr, i64 }, { ptr, i64 } }) align 8 dereferenceable(32) %0, ptr nonnull align 1 %1, i64 %2, i64 %3) unnamed_addr #0 !dbg !59 {
start:
  ...
  %19 = bitcast ptr %10 to ptr, !dbg !76
  store i64 %2, ptr %19, align 8, !dbg !76
  ...
  %24 = bitcast ptr %8 to ptr, !dbg !85
  store ptr %1, ptr %24, align 8, !dbg !85
...
bb3:                                              ; preds = %bb2
  %25 = call { ptr, i64 } @_ZN4core5slice3raw18from_raw_parts_mut17h0b15c6eeb412adb8E(ptr %1, i64 %3), !dbg !91
  %26 = extractvalue { ptr, i64 } %25, 0, !dbg !91
  %27 = extractvalue { ptr, i64 } %25, 1, !dbg !91
  %28 = bitcast ptr %4 to ptr
...
bb2.i:                                            ; preds = %bb3
  %33 = bitcast ptr %1 to ptr, !dbg !107
...
"_ZN4core3ptr7mut_ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$3add17h1171b2ede0480fe3E.exit": ; preds = %bb2.i, %bb3
  ...
  %36 = call { ptr, i64 } @_ZN4core5slice3raw18from_raw_parts_mut17h0b15c6eeb412adb8E(ptr %34, i64 %35), !dbg !111
  %37 = extractvalue { ptr, i64 } %36, 0, !dbg !111
  %38 = extractvalue { ptr, i64 } %36, 1, !dbg !111
  %39 = bitcast ptr %0 to ptr, !dbg !112
  store ptr %26, ptr %39, align 8, !dbg !112
  %40 = bitcast ptr %0 to ptr, !dbg !112
  %41 = getelementptr inbounds i8, ptr %40, i64 8, !dbg !112
  %42 = bitcast ptr %41 to ptr, !dbg !112
  store i64 %27, ptr %42, align 8, !dbg !112
  %43 = bitcast ptr %0 to ptr, !dbg !112
  %44 = getelementptr inbounds i8, ptr %43, i64 16, !dbg !112
  %45 = bitcast ptr %44 to ptr, !dbg !112
  store ptr %37, ptr %45, align 8, !dbg !112
  %46 = getelementptr inbounds i8, ptr %44, i64 8, !dbg !112
  %47 = bitcast ptr %46 to ptr, !dbg !112
  store i64 %38, ptr %47, align 8, !dbg !112
  ret void, !dbg !113
}

; Function Attrs: inlinehint nounwind
define { ptr, ptr } @"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$4iter17hffcb055fac345fcdE"(ptr nonnull align 8 %0, i64 %1) unnamed_addr #0 !dbg !114 {
start:
  ...
  %7 = call { ptr, ptr } @"_ZN4core5slice4iter13Iter$LT$T$GT$3new17h9caec572c36ac217E"(ptr nonnull align 8 %0, i64 %1), !dbg !142
  %8 = extractvalue { ptr, ptr } %7, 0, !dbg !142
  %9 = extractvalue { ptr, ptr } %7, 1, !dbg !142
  %10 = insertvalue { ptr, ptr } undef, ptr %8, 0, !dbg !143
  %11 = insertvalue { ptr, ptr } %10, ptr %9, 1, !dbg !143
  ret { ptr, ptr } %11, !dbg !143
}
...
; Function Attrs: inlinehint nounwind
declare hidden void @"_ZN4core3ptr7mut_ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$3add18precondition_check17hc776c183d9ddbe30E"(ptr, i64, i64) unnamed_addr #0

; Function Attrs: inlinehint nounwind
declare void @_ZN4core3fmt9Arguments9new_const17hdf2f30aca51edfbdE(ptr noalias nocapture sret({ { ptr, i64 }, { ptr, i64 }, { ptr, i64 } }) align 8 dereferenceable(48), ptr nonnull align 8) unnamed_addr #0

; Function Attrs: inlinehint noreturn nounwind
declare hidden void @_ZN4core9panicking9panic_fmt17hbcd5653c6dc71186E(ptr noalias nocapture align 8 dereferenceable(48), ptr nonnull align 8) unnamed_addr #1

; Function Attrs: inlinehint nounwind
declare void @"_ZN4core5slice4iter23ChunksExactMut$LT$T$GT$3new17ha5b9700c82ce6b00E"(ptr noalias nocapture sret({ { ptr, i64 }, { ptr, i64 }, i64, {} }) align 8 dereferenceable(40), ptr nonnull align 1, i64, i64) unnamed_addr #0
...
; Function Attrs: inlinehint nounwind
declare { ptr, i64 } @_ZN4core5slice3raw18from_raw_parts_mut17h0b15c6eeb412adb8E(ptr, i64) unnamed_addr #0

; Function Attrs: inlinehint nounwind
declare { ptr, ptr } @"_ZN4core5slice4iter13Iter$LT$T$GT$3new17h9caec572c36ac217E"(ptr nonnull align 8, i64) unnamed_addr #0
...
!71 = !DILocalVariable(name: "ptr", scope: !72, file: !5, line: 2055, type: !73, align: 8)
...
!94 = !DIFile(filename: "/root/.rustup/toolchains/nightly-2025-03-02-x86_64-unknown-linux-gnu/lib/rustlib/src/rust/library/core/src/ptr/mut_ptr.rs", directory: "", checksumkind: CSK_MD5, checksum: "03f9fff5488f048affd5530a4bafc084")
!95 = !DINamespace(name: "{impl#0}", scope: !96)
!96 = !DINamespace(name: "mut_ptr", scope: !97)
!97 = !DINamespace(name: "ptr", scope: !8)
...
!118 = !{!119, !128, !129}
!119 = !DIDerivedType(tag: DW_TAG_member, name: "ptr", scope: !117, file: !12, baseType: !120, size: 64, align: 64, flags: DIFlagPrivate)
